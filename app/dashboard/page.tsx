        ...
        <div className="bg-white shadow-xl rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-md hover:shadow-lg transition">
              <h3 className="text-lg font-semibold mb-2 text-gray-700">muc tieu trong ngay</h3>
            </div>

            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-md hover:shadow-lg transition">
              <h3 className="text-lg font-semibold mb-2 text-gray-700">muc tieu trong thang</h3>
            </div>

            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-md hover:shadow-lg transition">
              <h3 className="text-lg font-semibold mb-2 text-gray-700">muc tieu trong nam</h3>
            </div>
